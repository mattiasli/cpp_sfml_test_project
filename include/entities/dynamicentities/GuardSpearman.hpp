...
class GuardSpearman : public NPCEntity {
public:
    GuardSpearman(Handler& handler, sf::Vector2f worldCoordinate);
...
private:
    ...
    static constexpr float defaultMovementSpeedExpectedValue = 0.4375f;
